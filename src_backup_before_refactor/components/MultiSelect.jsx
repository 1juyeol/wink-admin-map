    ...
    const renderOption = (option) => {
        ...
        return (
            <div
                key={option}
                className={cn(
                    "px-4 py-3 text-[15px] cursor-pointer rounded-xl flex items-center gap-4 transition-all group",
                    isSelected
                        ? "bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 font-black"
                        : "hover:bg-gray-100 dark:hover:bg-slate-700 text-gray-700 dark:text-slate-300 font-bold"
                )}
                ...
                {isCompareMode ? (
                    <div className="flex items-center gap-3 w-full">
                        ...
                        <div className="flex items-center gap-1.5 shrink-0 opacity-80 group-hover:opacity-100 transition-opacity">
                            <span className="text-[10px] text-gray-400 font-medium">제한:</span>
                            <span className="text-sm font-black text-rose-500">{stats.totalDenied}</span>
                        </div>
                        <button
                    ...
                    <>
                        ...
                        <div className="flex flex-col items-end shrink-0">
                            <div className="flex items-center gap-2">
                                <span className="text-[10px] text-gray-400 font-black leading-none uppercase tracking-tighter">미접근</span>
                                <span className="text-2xl font-black text-rose-500 leading-none">{stats.totalDenied}</span>
                            </div>
                            <div className="flex gap-1.5 mt-0.5 opacity-60">
                                <span className="text-[8px] px-1 bg-gray-100 dark:bg-slate-700 rounded text-gray-500 font-bold">메뉴 {stats.deniedMenus}</span>
                                <span className="text-[8px] px-1 bg-gray-100 dark:bg-slate-700 rounded text-gray-500 font-bold">버튼 {stats.deniedButtons}</span>
                            </div>
                        </div>
                    </>
                )}
